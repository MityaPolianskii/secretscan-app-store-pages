(() => {
  ...
  const copy = {
    en: {
      ...
      share: {
        url: "https://secretscan-analytics.web.app/screenshot-exposure-check.html",
    ...
    es: {
      ...
      share: {
        url: "https://secretscan-analytics.web.app/es/revisar-captura-sensible.html",
    ...
    de: {
      ...
      share: {
        url: "https://secretscan-analytics.web.app/de/geteilten-screenshot-pruefen.html",
    ...
    ru: {
      ...
      share: {
        url: "https://secretscan-analytics.web.app/ru/proverit-otpravlennyy-skrinshot.html",
